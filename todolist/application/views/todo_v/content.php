        ...
        <table id="myTable" class="display" data-pagelength="5">
            ...
            <?php foreach ($items as $item) { ?>
                <tr data-gorev-id="<?php echo $item->id; ?>">
                    ...
                    <td>
                        <?php echo ' <span class="badge badge-primary"><small>' . date("d-m-Y", strtotime($item->createdDate)) . '</small></span>'; ?>
                        <?php

                        if ($item->completedDate != "0000-00-00 00:00:00") {
                            echo ' <span class="badge badge-success"><small>' . date("d-m-Y", strtotime($item->completedDate)) . '</small></span>';
                        } else {
